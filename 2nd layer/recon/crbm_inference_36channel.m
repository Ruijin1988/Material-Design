%% crbm_inference
function [poshidexp2] = crbm_inference_36channel(image, patch, W, weight, Tlist, params, ii)
    rng(0);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fname = sprintf('hidstate_2ndlayer_alloy(poolratio02)_(24f80f6ws9ws)_%d',ii);

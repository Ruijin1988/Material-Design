function [acc, weight, params] = demo_cifar10_5th_layer...
...
npatch = 1000; %%% test,original 12000
[xtrain, patches] = load_patches_5th_layer(npatch, params.rs);
...
if strcmp(params.txtype, 'rot'),
    fname = sprintf('rbm_circlecut_test2_5thlayer_(1f1000f500f100f30f12ws189ws1ws)_%s_w%d_b%02d_%s_nrot%d_pb%g_pl%g', ...
...
elseif strcmp(params.txtype, 'trans') || strcmp(params.txtype, 'scale'),
    fname = sprintf('rbm_circlecut_test2_5thlayer_(1f1000f500f100f30f12ws189ws1ws)_%s_w%d_b%02d_%s_ntx%d_gr%d_pb%g_pl%g', ...
...
%     [weight, params] = training_2nd_layer(patches', params, Tlist);
    [weight, params] = training_5th_layer(patches', params);
end
clear patches;
